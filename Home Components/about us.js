...
const AboutUs = () => {
  return (
    ...
    <div className="about-us" id="about us">
      ...
      <p style={{color:'white'}}>Welcome to our company! We are dedicated to providing high-quality products and excellent customer service. Our team is passionate about what we do and we strive to exceed our customers' expectations.</p>
    ...
    <div className="team">
      ...
      <h4 style={{paddingLeft:'15px'}}>Bumbu</h4><br></br>
      ...
      <a class="link1 facebook1" href="https://www.facebook.com/groups/indian.railway.ticket.agency/">
        ...
        <a class="link1 instagram1" href="https://instagram.com/irctc_train_ticket?igshid=MzRlODBiNWFlZA==">
            <i class="fab fa-1x fa-instagram"></i>
        </a>
        </div>
      </div> 
